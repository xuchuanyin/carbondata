 ...
 */
  ...
  public static class VariableCarbonRowSchema extends CarbonRowSchema {
    ...
    public VariableCarbonRowSchema(DataType dataType, boolean isLongString) {
      super(dataType);
    ...
    @Override public DataMapSchemaType getSchemaType() {
      return isLongString ? DataMapSchemaType.VARIABLE_INT : DataMapSchemaType.VARIABLE_SHORT;
    }
  }
